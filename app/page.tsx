...
export default function Home() {
    return (
        <main className="flex flex-col min-h-screen w-full relative select-none">
            <div
                className="flex flex-col bg-cover bg-center bg-no-repeat sm:h-[55vh] xl:h-[55vh] md:h-[50vh] lg:h-[50vh] h-[45vh] w-full relative"
                style={{
                ...
                <div className={'flex flex-col self-center items-center justify-center mt-2'}>
                    <div className={'brightness-125'}>
                        <Image
                            draggable={false}
                            className={'rounded-full fade-into-background border-4 border-blue-600 2xl:h-[200px] 2xl:w-[200px] lg:h-[150px] lg:w-[150px] md:h-[125px] md:w-[125px] sm:h-[100px] sm:w-[100px] h-[100px] w-[100px]'}
