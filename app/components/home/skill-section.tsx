...
function Skills() {
    return (
        <div className={'flex flex-col self-center items-center justify-center mt-8'}>
            <div className={'grid grid-cols-11 gap-12 grid-rows-3 items-center justify-center select-none grid-flow-row'}>
                ...
                <Image width={50} height={50} draggable={false}
                       src="/gradle-icon.png"
                       alt="Maven" title="Gradle"/>
                <Image width={50} height={50} draggable={false}
                       src="https://user-images.githubusercontent.com/25181517/190229463-87fa862f-ccf0-48da-8023-940d287df610.png"
                       alt="Lombok" title="Lombok"/>
                ...
                <Image width={50} height={50} draggable={false}
                       src="https://github.com/marwin1991/profile-technology-icons/assets/136815194/3c698a4f-84e4-4849-a900-476b14311634"
                       alt="MariaDB" title="MariaDB"/>
                <Image width={50} height={50} draggable={false}
