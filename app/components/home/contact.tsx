...
import DiscordModal from "@/app/components/home/discord-modal";
...
function ContactForm({name}: Props) {
    ...
    return (
        <>
            {isDiscordModalOpen && <DiscordModal/>}
                ...
                <div className={'w-[100%] relative'}>
                    <div className={`w-max h-max `}>
                        <Image
                            ...
                            alt={'Test'}
                            className={`${hoveringContactForm ? 'blur-sm' : ''} overflow-hidden transition-all duration-300`}>
                        </Image>
                    </div>
                    <div
                    ...
                    >
                        <div
                            className={` ${hoveringContactForm ? 'backdrop-blur-xl' : 'backdrop-blur-sm'} transition-all duration-700 relative lg:top-10 top-20 transform w-max h-max bg-gray-700 bg-opacity-55  rounded-xl shadow shadow-black justify-center items-center p-8`}
                        >
                            <div
             ...
             text-base w-full font-medium leading-none text-primary p-4
              focus:outline-none bg-transparent resize-none`}
                                    ...
                                    <label>
                                        ...
                                        Ich accept the <a href={'/privacy'} target={'_blank'}
                                                          className={'underline text-blue-500'}>privacy policy</a>
                                    </label>
                                    <button disabled={!validEmail || email.length == 0} className={`bg-opacity-35
                                 bg-gray-800 rounded-lg pl-4 pr-4 p-2 mt-2.5`}>Submit
                                    </button>
                                </form>
                            </div>
                        </div>
